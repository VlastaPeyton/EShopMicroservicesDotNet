...
{   /*Zajednicka struktura za sve Integration Events used in async microservice communication, jer
    ...
    istog microservice.
      ...
      DomainEvent je implmentirao IDomainEvent jer IDomainEvent : INotification zbog MediatR, ali ovde nema MediatR
    vec RabbitMQ, pa ne radimo IIntegrationEvent interface. Tj ova klasa ce biti pandan IDomainEvent */
