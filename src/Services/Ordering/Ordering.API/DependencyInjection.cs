...
{   /*Ovo sto pisem ovde, bih morao pisati u Program.cs, ali da tamo ne gomilam kod za svaki layer, zato pisem u ovoj klasi extension method za IServiceCollection 
    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddApiServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            /* Custom Exception Handler from BuildingBlocks da u Postman lepsa poruka bude 
            mora u API jer Endpoint je API layer */
        ...
        // Ovo je ono nakon builder.Build() iz Program.cs i ovo samo u API layer ima. Ostali layeri samo ovaj extension iznad imaju.
        public static WebApplication UseApiServices(this WebApplication app)
        { 
            app.MapCarter(); // u Clean architecture u API layer je Endpoint klasa
