...
{   /* Zbog DDD pravimo IDomainEvent koga ce da implementira svaki Domain Event (OrderCreatedEvent i OrderUpdatedEvent).
    ...
    {   // INotification je iz MediatR da dopusta prenos i primanje of DomainEvent kroz Mediator . Videti DispatchDomainEventsInterceptor i Domain EventHandlers klase
        
        // IDomainEvent tj DomainEvent mora imati ista polja kao Integration Event, jer u RabbitMQ se mapiraju 
