...
{   
    ...
    public record OrderId
    {
        ...
        private OrderId(Guid value) => Value = value; // Konstruktor na moderan nacin jer imam 1 polje samo
        ...
        {
            /* Validacija se radi u klasi jer je custom type. Ne mogu koristiti BuildingBlocks za FluentValidaiton in MediatR
